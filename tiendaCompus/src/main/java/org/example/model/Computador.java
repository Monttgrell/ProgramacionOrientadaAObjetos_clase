...
public class Computador {
    ...
    public Computador(String marca, int serie, Cpu cpu, Ram ram, Disco disco) throws Exception {
        this.setMarca(marca);
        this.setSerie(serie);
        this.setCpu(cpu);
        this.setMemorias(ram);
        this.setDiscos(disco);
    }
    ...
    public void setCpu(Cpu cpu) throws Exception {
        if (cpu!=null) {
            ...
            throw new Exception("Debe agregar un cpu");
        }
    }
    ...
    public void setVideo(TarjetaVideo video) throws Exception {
        if (video!=null) {
            ...
            throw new Exception("Debe agregar una tarjeta de video");
        }
    }
    ...
    public String toString() {
        ...
        sb.append(", memoria=").append(memorias);
        sb.append(", disco=").append(discos);
